              ...
              >
                <div className="flex flex-col justify-center items-center">
                  ...
                  <button
                    className={`${
                      name === itemName
                        ? "text-white bg-blue hover:bg-blue-hover border-gray pl-8 pr-6 gap-x-3"
                        : "text-blue w-16"
                    } border-2 border-gray-300 rounded-full h-16 flex justify-center items-center mt-8`}
                  >
                    {name === itemName && (
                      <div className="text-lg font-medium">Start mining</div>
                    )}
                    <IoIosArrowForward
                      className={`${name === item ? "text-2xl" : "text-3xl"}`}
                    />
                  </button>
                </div>
              </div>
